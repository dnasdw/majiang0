...
namespace sdw.unity
{
    public static class CMonoBehaviourExtension
    {
        public static void SafeStopCoroutine(this MonoBehaviour a_MonoBehaviour, ref Coroutine a_Coroutine)
        {
            ...
            a_MonoBehaviour.StopCoroutine(a_Coroutine);
            a_Coroutine = null;
        }
    }
}
