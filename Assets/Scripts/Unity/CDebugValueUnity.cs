...
namespace majiang0
{
    public class CDebugValueUnity : MonoBehaviour
    {
        public static CDebugValueUnity Instance { get; private set; }

        public bool m_bIsShowAllMahjong = false;

        private CDebugValueUnity()
        {
            Instance = this;
        }
