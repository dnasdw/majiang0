...
namespace majiang0
{
    public class CBindPlayerPanel : MonoBehaviour
    {
        public RectTransform m_CombRectTransform = null;
        public RectTransform m_HandCardRectTransform = null;

        private void Awake()
        {
            if (m_CombRectTransform == null)
            {
                Debug.LogError("set CombRectTransform first");
                return;
            }
            if (m_HandCardRectTransform == null)
            {
                Debug.LogError("set HandCardRectTransform first");
                return;
            }
        }
