...
namespace majiang0
{
    public class CDebugValue
    {
        public static void SetIsShowAllMahjong(bool a_bIsShowAllMahjong)
        {
            if (CDebugValueUnity.Instance != null)
            {
                CDebugValueUnity.Instance.m_bIsShowAllMahjong = a_bIsShowAllMahjong;
            }
        }

        public static bool IsShowAllMahjong()
        {
            if (CDebugValueUnity.Instance != null)
            {
                return CDebugValueUnity.Instance.m_bIsShowAllMahjong;
            }
            return false;
        }
    }
