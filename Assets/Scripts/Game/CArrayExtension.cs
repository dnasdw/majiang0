...
namespace sdw.game
{
    public static class CArrayExtension
    {
        public static void RecursiveClear(this Array a_Array)
        {
            CJaggedArray.Clear(a_Array);
        }

        public static void RecursiveClear<V>(this Array a_Array)
        {
            CJaggedArray.Clear<V>(a_Array);
        }
    }
}
